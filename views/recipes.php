...
<button type="submit" name ="selectrecipe" value="recherche" class="btn delicious-btn">Chercher</button>
</div>
</div>
</form>
</div>
...
<div class="receipe-post-search mb-80">
<div class="container">
<h4>Recherche par <span style="color: #1c8314;">Ingredient</span> :</h4>
<form action="<?='?selectrecipe'?>" method="post">
<div class="row">
<div class="col-12 col-lg-3">
<input type="search" name="Ingredient1" placeholder="Ingredient">
</div>
<div class="col-12 col-lg-3">
<input type="search" name="Ingredient2" placeholder="Ingredient">
</div>
<div class="col-12 col-lg-3">
<input type="search" name="search" placeholder="Ingredient">
</div>
<div class="col-12 col-lg-3 text-right">
<button type="submit" name="selectrecipe" value="recherche" class="btn delicious-btn">Chercher</button>
</div>
